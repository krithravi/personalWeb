                    ...
                    <p>
                        These are ranked vaguely in the order I need them.
                            <ul>
                                ...
                                <li>Git</li>
                                <li>A desktop environment or tiling manager</li>
                    ...
                    <p>
                        <ul>
                            ...
                            <li> I need a multilingual keyboard with dead keys. I prefer having <code class="inline">AltGr</code> as 
                                ...
                                I typically set <code class="inline">Compose</code> to the corresponding dead key.
                            </li>
                            <li>On startup, I want a dock-like thing (Plank on GNOME-based DEs) and a terminal (Terminator).
