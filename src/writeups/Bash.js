    ...
    return(
        <div>
		    ...
		    <h4>Stuff that didn't work</h4>
                <p>Based on StackOverflow's answers, I enclosed my prompt in <span class="monospace">\[</span> and <span class="monospace">\]</span>, to get <span class="monospace">\[\e[1;32mKR$ \e[m\]</span>, but that
		        was even worse.</p>
            <h4>The Solution</h4>
