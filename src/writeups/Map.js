	...
	return(
		<div>
			...
			<div className="box">
				<h3>The Problem</h3>
					<p>
						The <span class="directory">Caps Lock</span> key serves mainly as a
						source of annoyance, and receives far too much real estate relative
						to its use. However, the <span class="directory">Esc</span> key is
						quite useful (I'm primarily a Vim user), but is far too hard to
						reach. Currently, &Eacute;owyn has altered key settings to make
						life a bit easier. The <span class="directory"> Caps Lock</span> key
						now acts like the <span class="directory">Esc</span> key.
					</p>
				...
				<h3>The Solution</h3>
					<p>
						<ol>
							<li> I installed the <span class="monospace">dconf-editor</span> using <div class="realcode"> sudo apt-get install
									dconf-tools</div>
							</li>
							...
							<li> Within these braces, I added <div class="realcode">
									'caps:escape'</div> to add the <span class="directory">Caps
									Lock</span> key as another <span class="directory">
									Esc</span>. The command you want to use needs to be enclosed in
